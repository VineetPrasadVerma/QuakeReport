...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
     ...
     * @param earthquakes is the list of earthquake to be displayed.
     */
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView offsetLocationTextView = convertView.findViewById(R.id.offset_location_text_view);
        offsetLocationTextView.setText(locationOffset);

        TextView primaryLocationTextView = convertView.findViewById(R.id.primary_location_text_view);
